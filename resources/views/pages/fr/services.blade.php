...
<div class="wrap">
    ...
    <section class="section">
        <h1 class="page-title">Un partenaire pour votre marque</h1>
    </section>
    ...
    <section class="section">
        <div class="callout">
            <p>Décrivez-nous votre projet en quelques lignes, nous vous répondons rapidement.</p>
            <a class="button" href="{{ route_ts('contact', ['locale' => app()->getLocale()]) }}">Parlons de votre projet</a>
        </div>
    </section>
